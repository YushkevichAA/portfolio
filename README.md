...
oldRepo: [старый репозиторий](https://github.com/yushkevich-a-a?tab=repositories) 
 
---

## Технические навыки:

- **Языки программирования:** JS, TS;
- **Стек:**

* FSD(приоритет), atomic design
* TS/JS, Node
* React, React hooks,
* Styled-components, CSS modules
* Consta, Bootstrap, MUI, создание своего UI kit
* HTML, DOM, browser API
* Redux, zustand,
* Zod,
* Vue 2 + vuex/pinia
* expressjs, nestjs
* sequelize, Knex, MikroOrm
...
- Февраль 2023 — сейчас
  - разработка системы визуализации на основе данных корпоративной системы мониторинга ( создание системы связанных дашбородов )
  - разработка приложения SPA - конструктора дашбордов.
  - разработка приложения SPA - управление авариями
  - добавление и доработка интерфейсов на стороне backend
  - написание SQL запросов.
  - перевод части сырых запросов на QueryBilder knex.
  - написание cli приложения для управления(создание, слияние, удаление) ветками git (тестовый вариант)
  - доработка визуальной части макетов приложения в figma (компонентный подход)

  - Стек:
    - архитектура FSD
    - front: React, Typescript, Zustand, React-hook-form, Zod, Rxjs, Consta, Styled-Components
    - back: express, sequelize, MS SQL. (переход на nest, PostgreSQL, mikroORM)
    - интеграция с API системы мониторинга
    - создание макетов в figma.
    - дополнительно: git, docker, VM, npm/yarn, SQLite, StoryBook
    - Поддержка существующего legacy проекта визуализации. JS, Vue2, Vuex, pug, chartjs, webpack, express, sequelize, MS SQL.

* 2022 июль - 2023 февраль, стартап "12people", разработка браузерной карточной игры с конвертацией в apk

* 2022 январь - 2022 апрель, проектная занятость в команде dfaktor (Проект закрылся)
